...
We analyzed whether the temporal differences in travel times for the destinations had statistical significance. Only destinations that appear in more than one year can have their temporal evolution analyzed. Therefore, for the twelve possible destinations in the cycling mode, only seven locations can be temporally analyzed: 'Cultural venues,' 'Grocery store,' 'Home,' 'Other's home,' 'Outdoors,' 'Restaurant,' and 'Work or school.' In the case of walking trips, it is possible to include 'Place of worship' to the previous destination list.
...
- walking trips start and finish at home (WRONG supposition)

- include typical differences for cases with statistics proof 

- Analyze all the functions together


- 64 functions for different locations

- exponential may no be the right function

- temporal differences were identified for some destinations, change in transport behaviour
