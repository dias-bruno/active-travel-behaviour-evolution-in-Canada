...
\caption{\label{tab:active_pop_proportion_table}\label{tab:active_pop_proportion_table}Count and share of population with at least one active travel episode by year}\\
\toprule
