...
An AT episode refers to a walking or cycling activity that a person did
...
```{r gender-perc-figure, echo=FALSE, out.width="100%", fig.cap="Prevelance in active transportation by gender."}
...
```{r age-perc-figure, echo=FALSE, out.width="100%", fig.cap="Prevelance in active transportation by age group."}
